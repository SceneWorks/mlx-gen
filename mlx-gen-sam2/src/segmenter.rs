...
/// The shared host bilinear resampler (`align_corners=False`, half-pixel centers), aliased to its
/// historical name here (F-171).
use crate::util::bilinear_resize_f32 as upsample_bilinear_f32;
